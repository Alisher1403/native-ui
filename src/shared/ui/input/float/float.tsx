...
import { InputFloatProps } from "./float.types";
import { useModel } from "./float.model";
import { styles } from "./float.style";
import Animated, { FadeIn, FadeOut } from "react-native-reanimated";

function InputFloat(props: InputFloatProps) {
...
export default React.memo(InputFloat);
