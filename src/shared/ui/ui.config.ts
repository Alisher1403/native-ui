...
export const UISpacing = DefaultAppTheme["spacing"];

export const UIRadius = DefaultAppTheme["radius"];

export const UIColors = DefaultAppTheme["colors"];

export const UIFontSize = DefaultAppTheme["fontSize"];
...
export type UIFontSizeType = keyof typeof UIFontSize;
